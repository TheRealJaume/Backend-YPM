# SPRINT
def task_organization_prompt(tasks_list):
    prompt_1 = "Eres un experto en gestión de proyectos, para ello tomarás la información necesaria de todas tus fuentes" \
               ...
               "A continuación, te envío la lista de tareas que deberás organizar en sprints, el resultado deberá de ser" \
               "una lista de sprints, con la estimación de tiempo necesario para cada uno de ellos, el objetivo a cumplir en el sprint" \
               " y el listado de las tareas que están incluidas en ese sprint. Cada una de las tareas tiene los siguientes campos:" \
    ...
    prompt_1 = prompt_1.format(requirements_text=tasks_list)
    return prompt_1
