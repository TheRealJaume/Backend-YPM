...
from ypm_ai.tasks.prompts.sprint.models import Sprints
...
class TaskOrganizationManager:
    ...
    def request_task_organization(self):
        ...
        task_prompt = task_organization_prompt(tasks_list=self.project_tasks)

        # Set up a parser + inject instructions into the prompt template.
        parser = JsonOutputParser(pydantic_object=Sprints)
